...
//        do#=277,re#=311,    fa#=370,sol#415,la#=466,
...
void aportuguesa () {                                                                                                                                                                                        //o esplendor de portugal                entre as brumas da memorias          o patria sentes se a voz                     dos teus egregios avos                                                                                as armas as armas                sobre a terra e sobre o mar       as amrmas as amrmas            pela patria lutar            contra os canhoes..

     int i,k;        //1                                           12                                       22                                              34                                        44                                       54                                  63                                   72                                               84                                      94                   99   100                       106                           113                                121                          128                                          139
     ...
     int tportu[]={1000,1000,1000,500,500,500,300,200,500,500,1000,400, 200,200,50,200,1000,700,200,500,500,350, 150,200,50,200,500,500,300,150,200,50,200,1000, 400,250,200,1000,500,300,200,1000,50,400, 90,300,200,700,200,300,200,300,200,1000, 999,750,250,500,500,25,750,250,600, 150,250,700,250,250,450,250,450,600, 400,350,150,500,350,150,500,350,150,450,50,600, 400,350,150,500,350,150,500,350,150,500, 250,250,250,250,250, 180,1100,600,200,200,1100,500, 350,150,500,500,500,500,1000, 700,180,1100,600,200,200,1100,500, 300,150,500,500,900,200,800, 500,250,250,250,500,500,800,200,500,500,600};
                                                                                                                                                                                                                                                                                                                                                                                                                                      // 293 - 250
    for (i=0;i<139;i++)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             //500,300,300,300,600,600,900,300,600,600,600};
    {
      if(portu[i]==0) {
         for (k=0;k<tportu[i];k++)
         {
            Delay_ms(1);
         }
      }
...
void silhouettes () {
    ...
    for (i=0;i<88;i++) {
      ...
      acender(silh[i]);
      Sound_Play(silh[i]*2, tsilh[i]/tm);
      off();
      Delay_ms(35);
      }
   }
...
void zanarkand() {
   ...
   for (i=0;i<49;i++) {
      if(zanark[i]==0) {
         for (k=0;k<tzanark[i];k++) {
            Delay_ms(1);
         }
      }
      else {
         acender(zanark[i]);
         Sound_Play(zanark[i]*2, tzanark[i]);
         off();
         Delay_ms(50);
      }
   }
...
void main() {
   ...
   osccon=0xff;
   adcon1 = 0x0f; //definir todas os pins como digital  pag.266 datasheet
   TRISA = 0x06;
   TRISB = 0xAA;  //1-in    0-out
   TRISC = 0x8A;
   TRISD = 0xA9;
